...
Download this [`quarto`](https://github.com/melinscribe/Workshop/blob/main/exercises/exercises_R.qmd) file with exercises. Solutions are on the [Solutions](solutions.html) page (released after the session).
